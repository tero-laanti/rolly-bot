...
import { diceBansButtonPrefix, handleDiceBansButton } from "./commands/minigames/dice-bans";
import {
  dicePrestigeButtonPrefix,
  handleDicePrestigeButton,
} from "./commands/minigames/dice-prestige";
import { diceAdminButtonPrefix, handleDiceAdminButton } from "./commands/minigames/dice-admin";
import { dicePvpButtonPrefix, handleDicePvpButton } from "./commands/minigames/dice-pvp";
import { dispatchButtonInteraction, registerButtonHandler } from "./lib/button-router";
import { randomEventsFoundationConfig } from "./lib/config";
import { initDatabase } from "./lib/db";
import { requireEnv } from "./lib/env";
import { getRollyDataSourceDescription, primeRollyData } from "./lib/rolly-data/load";
import {
  createRandomEventsLiveRuntime,
  type RandomEventsLiveRuntime,
} from "./lib/minigames/random-events-live-runtime";
import { startRandomEventsFoundationScheduler } from "./lib/minigames/random-events-foundation";
import { randomEventButtonPrefix } from "./lib/minigames/random-event-interaction-window";
import {
  clearRandomEventsAdminController,
  registerRandomEventsAdminController,
} from "./lib/minigames/random-events-admin";
import { createRandomEventsState } from "./lib/minigames/random-events-state";
