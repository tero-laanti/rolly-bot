...
test("getTopPrestigeEntries sorts by prestige, dice count, then earlier timestamp", () => {
  ...
  assert.deepEqual(progression.getTopPrestigeEntries(3), [
    { userId: "user-2", prestige: 4, diceCount: 2 },
    { userId: "user-1", prestige: 4, diceCount: 2 },
