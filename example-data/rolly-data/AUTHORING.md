...
- [contracts.v1.md](contracts.v1.md): daily/weekly contracts, objective counters, and pips/fame rewards.
...
- [raids.md](raids.md): World Boss rewards, boss naming, and boss-balance tuning.
